...
namespace Sodao.FastSocket.Server
{
    ...
    public class SocketServerManager
    {
        ...
        static private readonly List<IUdpServer> _listUdp = new List<IUdpServer>(); 
        #endregion
        ...
        static public void Init(Config.SocketServerConfig config)
        {
            ...
            foreach (Config.Server serverConfig in config.Servers)
            {
                ...
                //var host = new Sodao.FastSocket.Server.UdpServer<AsyncBinaryCommandInfo>(9500, new UdpProtocol(), new UdpService()); 
            }
        }
        /// <summary>
        /// get protocol.
